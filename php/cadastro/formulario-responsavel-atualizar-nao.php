        ...
        $formulario_responsavel_nao = "<div class='row'>
                                        <div class='col-md-1'>
                                            <div class='form-group'>
                                                ...
                                                <input type='text' class='form-control input-default' required='required' name='matricula_nao' style='text-transform: uppercase;'>
                                            </div>
                                        </div>
                                        <div class='col-md-7'>
                                            <div class='form-group'>
                                    ...
                                    <script type='text/javascript' src='../js/buscar-dados-aluno-nao.js'></script>";
