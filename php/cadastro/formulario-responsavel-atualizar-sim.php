<?php
        $formulario_responsavel_sim = "<div class='row'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-1'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text' class='form-control input-default' required='required' name='matricula_sim' style='text-transform: uppercase;'>
                                                </div>
                                            </div>
                                            <div class='col-md-5'>
                                                <div class='form-group'>
                                        ...
                                        <script type='text/javascript' src='../js/buscar-dados-aluno-responsavel-sim.js'></script>";
