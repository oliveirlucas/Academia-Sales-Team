...
if(mysqli_num_rows($resultado_usuario) <= 0){
    ...
    if($dados['IND_RESPONSAVEL'] == "N"){
        ...
        $contrato .= "<p>Declaro que este contrato e unico e exclusivo do aluno <b>".$dados['NOM_ALUNO']."</b>,";
        $contrato .= " portador do CPF <b>".$dados['CPF']."</b>, RG <b>".$dados['RG']."</b>, a qual nasceu na data <b>".date('d/m/Y',strtotime($data))."</b>, reside atualmente no endereço ";
       ...
       <center> Assinatura:___________________________________________________________</center>";
        ...
        $busca_responsavel = "SELECT RES.* FROM aluno ALU
                            INNER JOIN responsavel RES
                            on ALU.COD_RESPONSAVEL = RES.COD_RESPONSAVEL 
                            where ALU.COD_ALUNO = '$cod_aluno'";
                  
        $resultado_busca_responsavel = mysqli_query($connect, $busca_responsavel);
        $dados_responsavel = mysqli_fetch_assoc($resultado_busca_responsavel);

        $data_responsavel = $dados_responsavel['DATA_NASCIMENTO'];

        $contrato = "<center><b><h5>TERMO DE ADESÃO PLANO DE ATIVIDADES FÍSICAS E LUTAS</h5></b></center>";

        $contrato .= "<center><b><h5>ACADEMIA SALES – ARTES MARCIAIS</h5></b></center>";

        $contrato .= "<p>Declaro que este contrato é unico e exclusivo do aluno <b>".$dados['NOM_ALUNO']."</b>, portador do CPF <b>".$dados['CPF']."</b>, ";
        $contrato .= "a qual nasceu na data <b>".date('d/m/Y',strtotime($data))."</b>, cujo o responsável pelo mesmo é o(a) <b>".$dados_responsavel['NOM_RESPONSAVEL']."</b>, portador do CPF <b>".$dados_responsavel['CPF']."</b>, ";
        $contrato .= "RG <b>".$dados_responsavel['RG']."</b>, a qual nasceu na data <b>".date('d/m/Y',strtotime($data_responsavel))."</b>, reside atualmente no endereço <b>".$dados_responsavel['ENDERECO']."</b>, ";
