...
$modalidade_nao = filter_input(INPUT_POST, 'modalidade_nao');
...
$status_nao = filter_input(INPUT_POST, 'status_nao');
    ...
    if($ind_responsavel == "Sim"){
        ...
        if($modalidade == "Selecione a modalidade"){
            $_SESSION['msgcadastro'] = "<div class='alert alert-danger' role='alert'>Modalidade não selecionada</div>";
            ...
            if($modalidade == "Muay Thai"){
                if($nivel == "Selecione a Prajied" || $nivel == "-- ADULTO --" || $nivel == "-- KIDS --"){
                    ...
                    if(mysqli_affected_rows($connect)){
                        ...
                        if(mysqli_affected_rows($connect)){
                                $inserir_aluno = "INSERT INTO aluno (NOM_ALUNO, TELEFONE, EMAIL, CPF, RG, DATA, ENDERECO, CIDADE, ESTADO, NIVEL, COD_MODALIDADE, STATUS, BAIRRO, CEP, DATA_REGISTRO, IND_RESPONSAVEL, COD_RESPONSAVEL) 
                                                VALUES ('$nome_aluno', NULL, NULL,'$cpf_aluno','$rg_aluno', '$data_aluno', NULL, NULL, NULL, '$nivel', 1, '$status', NULL, NULL, now() ,'S',(
                            ...
                            if(mysqli_insert_id($connect)){
                                ...
                                $inserir_aluno = "INSERT INTO aluno (NOM_ALUNO, TELEFONE, EMAIL, CPF, RG, DATA, ENDERECO, CIDADE, ESTADO, NIVEL,COD_MODALIDADE, STATUS, BAIRRO, CEP, DATA_REGISTRO, IND_RESPONSAVEL, COD_RESPONSAVEL) 
                                                        VALUES ('$nome_aluno', NULL, NULL,'$cpf_aluno', '$rg_aluno', '$data_aluno', NULL, NULL, NULL, '$nivel',1, '$status', NULL, NULL, now() ,'S',(SELECT COD_RESPONSAVEL FROM responsavel where CPF = '$cpf_responsavel'))";
                                $resultado_inserir_aluno = mysqli_query($connect, $inserir_aluno);
                    ...
                    if(mysqli_affected_rows($connect)){
                        ...
                        if(mysqli_affected_rows($connect)){
                                $inserir_aluno = "INSERT INTO aluno (NOM_ALUNO, TELEFONE, EMAIL, CPF, RG, DATA, ENDERECO, CIDADE, ESTADO, NIVEL, COD_MODALIDADE, STATUS, BAIRRO, CEP, DATA_REGISTRO, IND_RESPONSAVEL, COD_RESPONSAVEL) 
                                                VALUES ('$nome_aluno', NULL, NULL,'$cpf_aluno','$rg_aluno', '$data_aluno', NULL, NULL, NULL, '$nivel', 2, '$status', NULL, NULL, now() ,'S',(
                                                SELECT COD_RESPONSAVEL FROM responsavel where CPF = '$cpf_responsavel'))";
                            ...
                            if(mysqli_insert_id($connect)){
                                ...
                                $inserir_aluno = "INSERT INTO aluno (NOM_ALUNO, TELEFONE, EMAIL, CPF, RG, DATA, ENDERECO, CIDADE, ESTADO, NIVEL,COD_MODALIDADE, STATUS, BAIRRO, CEP, DATA_REGISTRO, IND_RESPONSAVEL, COD_RESPONSAVEL) 
                                                        VALUES ('$nome_aluno', NULL, NULL,'$cpf_aluno', '$rg_aluno', '$data_aluno', NULL, NULL, NULL, '$nivel',2, '$status', NULL, NULL, now() ,'S',(SELECT COD_RESPONSAVEL FROM responsavel where CPF = '$cpf_responsavel'))";
                                $resultado_inserir_aluno = mysqli_query($connect, $inserir_aluno);
        ...
        if($modalidade_nao == "Selecione a modalidade"){
            $_SESSION['msgcadastro'] = "<div class='alert alert-danger' role='alert'>Modalidade não selecionada</div>";
            header("Location: ../../pages/cadastro-aluno.php");
            ...
            if($modalidade_nao == "Muay Thai"){
                if($nivel_nao == "Selecione a Prajied" || $nivel_nao == "-- ADULTO --" || $nivel_nao == "-- KIDS --"){
                    ...
                    if(mysqli_affected_rows($connect)){
                        ...
                        $inserir_aluno  = "INSERT INTO aluno(NOM_ALUNO, TELEFONE, EMAIL, CPF, RG, DATA, ENDERECO, CIDADE, ESTADO, NIVEL,COD_MODALIDADE, STATUS, BAIRRO, CEP, DATA_REGISTRO, IND_RESPONSAVEL, COD_RESPONSAVEL) 
                        VALUES ('$nome_aluno_nao','(".$ddd_nao.") $telefone_nao','$email_nao','$cpf_nao','$rg_nao','$data_nao','$endereco_nao Nº".$numero_nao."','$cidade_nao','$estado_nao','$nivel_nao',1,'$status_nao','$bairro_nao','$cep_nao',now(),'N',NULL)";
                    ...
                    if(mysqli_affected_rows($connect)){
                        ...
                        $inserir_aluno  = "INSERT INTO aluno(NOM_ALUNO, TELEFONE, EMAIL, CPF, RG, DATA, ENDERECO, CIDADE, ESTADO, NIVEL,COD_MODALIDADE, STATUS, BAIRRO, CEP, DATA_REGISTRO, IND_RESPONSAVEL, COD_RESPONSAVEL) 
                        VALUES ('$nome_aluno_nao','(".$ddd_nao.") $telefone_nao','$email_nao','$cpf_nao','$rg_nao','$data_nao','$endereco_nao Nº".$numero_nao."','$cidade_nao','$estado_nao','$nivel_nao',2,'$status_nao','$bairro_nao','$cep_nao',now(),'N',NULL)";
